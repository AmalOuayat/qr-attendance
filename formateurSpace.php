...
<body>
    <div class="wrapper">
        ...
        <nav id="sidebar" class="sidebar hidden" aria-label="Sidebar">
            <h2>Interface Formateur</h2>
            <button id="close-sidebar" class="close-sidebar" aria-label="Close sidebar">
                <i class="bi bi-x-lg"></i>
            </button>
            <ul>
                <li><a target="iframe" href="formateur_dashboard.php" class="nav-link"><i
                            class="bi bi-speedometer2"></i> Tableau de bord</a></li>
                <li class="title">Pages</li>
                <li><a target="iframe" href="vue_cours.php" class="nav-link"><i class="bi bi-book"></i> Vue des
                        Cours</a></li>
                <li><a target="iframe" href="historique_presences_formateur.php" class="nav-link"><i
                            class="bi bi-calendar-check"></i> Historique des Présences</a></li>
                <!-- <li><a target="iframe" href="ressources_formateur.php" class="nav-link"><i
                            class="bi bi-file-earmark-excel"></i> ressources Cours</a></li> -->
        ...
        <div class="main-content full-width">
            ...
            <main>
                <iframe src="formateur_dashboard.php" id="iframe" name="iframe" frameborder="0"
